...
![](img/ml02.jpg){.absolute width="800" right="-170" top="130"}
...
Projeto IARAA (Inteligência Artificial para Reconhecimento Ambiental da Amazônia)

![](img/iaraaa.png){.absolute width=200 right=-150 top=0}

![](video/iaraa_mamiferos.mp4){.absolute width=280 right=770 top=200}
![](video/iaraa_aves.mp4){.absolute width=280 right=380 top=200}
![](video/iaraa_peixes.mp4){.absolute width=280 right=10 top=200}

:::footer
[Projeto IARAA](https://www.instagram.com/projetoiaraa/)
:::
...
[https://github.com/mauriciovancine/workshop-r-data-manipulation](https://github.com/mauriciovancine/workshop-r-data-manipulation)
...
::: footer
[workshop-r-data-manipulation](https://github.com/mauriciovancine/workshop-r-data-manipulation)
:::
...
::: footer
[R Markdown + R + RStudio](https://ohi-science.org/globalfellows/why_rmarkdown.html)
:::
...
![](img/code_snake_case.png){.absolute width="500" right="150" top="350"}

::: footer
[Mengenal 4 Macam Gaya Penulisan Case dalam Kode Program](https://www.petanikode.com/case-kode-program/)
:::
...
![](img/conflicted.jpeg){.absolute width=600 right=0 top=400}

::: footer
[conflicted](https://conflicted.r-lib.org/index.html)
:::
